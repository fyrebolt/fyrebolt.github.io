  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg-primary)] text-[var(--color-text-primary)]">
      ...
      <main className="max-w-6xl mx-auto px-6 pb-24">
        ...
        <p className="text-[var(--color-text-secondary)] mt-2 mb-8 max-w-2xl">
          Overlay a Smash-style character-intro banner on your footage and format it for vertical
          short-form. Upload, place the freeze point, and export an MP4.
        </p>
